...
By default, X1coin allows up to 125 connections to different peers, 10 of
...
limits are tiny. Keep in mind that x1coin's trustless model works best if you are
