...
complete --command x1coin-qt --no-files

# Extract options
function __fish_x1coinqt_get_options
...
complete \
    --command x1coin-qt \
    --arguments "(__fish_x1coinqt_get_options --nofiles)"
