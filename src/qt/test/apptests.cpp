...
//! Entry point for X1coinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &X1coinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for X1coinGUI tests.
void AppTests::guiTests(X1coinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &X1coinGUI::consoleShown, this, &AppTests::consoleTests);
