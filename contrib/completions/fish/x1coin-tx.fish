...
# Extract options
function __fish_x1coin_tx_get_options
...
# Extract commands
function __fish_x1coin_tx_get_commands
...
complete \
    --command x1coin-tx \
    --condition "not __fish_x1coin_seen_cmd (__fish_x1coin_tx_get_commands --commandsonly)" \
    --arguments "(__fish_x1coin_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command x1coin-tx \
    --arguments "(__fish_x1coin_tx_get_commands)" \
    --no-files
