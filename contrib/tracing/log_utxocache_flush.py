...
"""Example logging X1coin utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/x1coind
...
def main(x1coind_path):
    ...
    b = BPF(text=program, usdt_contexts=[x1coind_with_usdts])
