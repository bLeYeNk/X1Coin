...
#ifndef BITCOINS_WALLET_WALLETUTIL_H
#define BITCOINS_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! bitcoins from opening the wallet, thinking it was newly created, and
...
#endif // BITCOINS_WALLET_WALLETUTIL_H
