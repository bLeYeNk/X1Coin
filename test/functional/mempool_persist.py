...
By default, bitcoinsd will dump mempool on shutdown and
...
class MempoolPersistTest(BitcoinsTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent bitcoinsd from writing mempool.dat to disk. Verify that `savemempool` fails")
