/* src/config/bitcoins-config.h.  Generated from bitcoins-config.h.in by configure.  */
/* src/config/bitcoins-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BITCOINS_CONFIG_H

#define BITCOINS_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Bitcoins Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Bitcoins Core"
...
#define PACKAGE_BUGREPORT "https://github.com/bLeYeNk/Bitcoins/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bitcoins Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitcoins Core 25.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitcoins"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://bitcoins.earth/"
