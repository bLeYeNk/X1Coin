...
"""Example logging Bitcoins Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/bitcoinsd
...
def main(bitcoinsd_path):
    ...
    b = BPF(text=program, usdt_contexts=[bitcoinsd_with_usdts])
