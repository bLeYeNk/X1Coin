...
class FullBlockTest(X1coinTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure x1coind isn't accepting b26
        ...
        # Extend the b28 chain to make sure x1coind isn't accepting b28
        ...
        # x1coind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the x1coin code has custom code which does so);
