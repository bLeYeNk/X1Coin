...
{
    // Test regression https://github.com/bLeYeNk/X1Coin/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/x1coin-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/x1coin-core/gui/pull/568.
    // With fListen=false in ~/.config/X1coin/X1coin-Qt.conf and all else left as default,
    // x1coin-qt should set both -listen and -listenonion to false and start successfully.
