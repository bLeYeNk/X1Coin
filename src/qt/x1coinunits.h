...
#ifndef X1COIN_QT_X1COINUNITS_H
#define X1COIN_QT_X1COINUNITS_H
...
/** X1coin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class X1coinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit X1coinUnits(QObject *parent);

    /** X1coin units.
      @note Source: https://en.x1coin.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        X1,
        mX1,
