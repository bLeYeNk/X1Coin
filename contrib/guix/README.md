...
This directory contains the files necessary to perform bootstrappable X1coin
Core builds.
...
To build X1coin reproducibly with all default options, invoke the
...
```
env DETACHED_SIGS_REPO=<path/to/x1coin-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/x1coin-core/guix.sigs).
