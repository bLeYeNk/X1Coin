Bitcoins Core version 0.9.2.1 is now available from:

  https://bitcoins.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 BC to 0.01 BC
...
- Fix "Start bitcoins on system login"
