...
#ifndef X1COIN_PROTOCOL_H
#define X1COIN_PROTOCOL_H
...
/**
 * X1coin protocol message types. When adding new message types, don't forget
...
enum ServiceFlags : uint64_t {
    ...
    // set by all X1coin non pruned nodes, and is unset by SPV clients or other light clients.
    NODE_NETWORK = (1 << 0),
    // NODE_BLOOM means the node is capable and willing to handle bloom-filtered connections.
    // X1coin nodes used to support this by default, without advertising this bit,
    ...
    // x1coin-development mailing list. Remember that service bits are just
