Bitcoins Core version 0.10.3 is now available from:

  <https://bitcoins.org/bin/bitcoins-core-0.10.3/>
...
(see https://github.com/bitcoins/bitcoins/pull/6793, as well as the 0.11.0
