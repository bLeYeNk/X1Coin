...
//! Entry point for BitcoinsApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &BitcoinsApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for BitcoinsGUI tests.
void AppTests::guiTests(BitcoinsGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &BitcoinsGUI::consoleShown, this, &AppTests::consoleTests);
