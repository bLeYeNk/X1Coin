...
#ifndef BITCOINS_QT_BITCOINSUNITS_H
#define BITCOINS_QT_BITCOINSUNITS_H
...
/** Bitcoins unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class BitcoinsUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit BitcoinsUnits(QObject *parent);

    /** Bitcoins units.
      @note Source: https://en.bitcoins.it/wiki/Units . Please add only sensible ones
     */
    enum class Unit {
        BC,
        mBC,
