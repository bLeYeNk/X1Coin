...
By default, x1coind will dump mempool on shutdown and
...
class MempoolPersistTest(X1coinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent x1coind from writing mempool.dat to disk. Verify that `savemempool` fails")
