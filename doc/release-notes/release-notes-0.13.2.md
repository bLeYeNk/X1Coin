Bitcoins Core version 0.13.2 is now available from:

  <https://bitcoins.org/bin/bitcoins-core-0.13.2/>
...
- #8908 `4a974b2` Update bitcoins-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow bitcoins-tx to create v2 transactions (bcdrak)
