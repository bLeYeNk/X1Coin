...
BOOST_AUTO_TEST_CASE(netbase_splithost)
{
    ...
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:15258", "::ffff:127.0.0.1", 15258));
    BOOST_CHECK(TestSplitHost("[::]:15258", "::", 15258));
    BOOST_CHECK(TestSplitHost("::15258", "::15258", 0));
    BOOST_CHECK(TestSplitHost(":15258", "", 15258));
    BOOST_CHECK(TestSplitHost("[]:15258", "", 15258));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:15258", "127.0.0.1:15258"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:15258", "[::]:15258"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
