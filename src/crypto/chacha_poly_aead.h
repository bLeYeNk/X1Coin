...
#ifndef X1COIN_CRYPTO_CHACHA_POLY_AEAD_H
#define X1COIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@x1coin.
 *
 ...
 *
 * The chacha20-poly1305@x1coin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@x1coin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@x1coin are relatively fast in
...
#endif // X1COIN_CRYPTO_CHACHA_POLY_AEAD_H
