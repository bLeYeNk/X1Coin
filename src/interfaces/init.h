...
#ifndef BITCOINS_INTERFACES_INIT_H
#define BITCOINS_INTERFACES_INIT_H
...
//! (bitcoins-gui, bitcoins-node, bitcoins-wallet, bitcoinsd, bitcoins-qt) and each
...
#endif // BITCOINS_INTERFACES_INIT_H
