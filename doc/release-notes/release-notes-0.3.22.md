Download URL: https://sourceforge.net/projects/bitcoins/files/Bitcoins/bitcoins-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 BC fee schedule (users still pay 0.01 BC per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #bitcoins00 - #bitcoins99
