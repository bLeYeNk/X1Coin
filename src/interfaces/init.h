...
#ifndef X1COIN_INTERFACES_INIT_H
#define X1COIN_INTERFACES_INIT_H
...
//! (x1coin-gui, x1coin-node, x1coin-wallet, x1coind, x1coin-qt) and each
...
#endif // X1COIN_INTERFACES_INIT_H
