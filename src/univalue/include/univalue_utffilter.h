...
#ifndef BITCOINS_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define BITCOINS_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // BITCOINS_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
