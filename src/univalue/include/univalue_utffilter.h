...
#ifndef X1COIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
#define X1COIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
...
#endif // X1COIN_UNIVALUE_INCLUDE_UNIVALUE_UTFFILTER_H
