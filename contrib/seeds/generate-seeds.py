...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef X1COIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define X1COIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the x1coin network\n')
    ...
    g.write('#endif // X1COIN_CHAINPARAMSSEEDS_H\n')
