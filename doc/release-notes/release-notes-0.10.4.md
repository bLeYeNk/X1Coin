Bitcoins Core version 0.10.4 is now available from:

  <https://bitcoins.org/bin/bitcoins-core-0.10.4/>
...
- #6953 `43c2789` Split bitcoins-tx into its own package
- #6953 `dfe0d4d` Include bitcoins-tx binary on Debian/Ubuntu
