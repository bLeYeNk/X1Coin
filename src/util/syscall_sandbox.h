...
#ifndef BITCOINS_UTIL_SYSCALL_SANDBOX_H
#define BITCOINS_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during bitcoinsd initialization if Bitcoins Core was compiled
...
#endif // BITCOINS_UTIL_SYSCALL_SANDBOX_H
