...
When complete, it will have produced `X1coin-Core.dmg`.
...
apt install cpio
git clone https://github.com/x1coin-core/apple-sdk-tools.git
...
- The Apple keyholder uses this unsigned app to create a detached signature, using the
  script that is also included there. Detached signatures are available from this [repository](https://github.com/x1coin-core/x1coin-detached-sigs).
