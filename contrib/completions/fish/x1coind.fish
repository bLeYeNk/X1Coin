...
complete --command x1coind --no-files

# Extract options
function __fish_x1coind_get_options
...
complete \
    --command x1coind \
    --arguments "(__fish_x1coind_get_options --nofiles)"
