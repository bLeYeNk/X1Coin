...
#ifndef X1COIN_WALLET_SCRIPTPUBKEYMAN_H
#define X1COIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The X1coin wallet was originally a collection of unrelated private
...
#endif // X1COIN_WALLET_SCRIPTPUBKEYMAN_H
