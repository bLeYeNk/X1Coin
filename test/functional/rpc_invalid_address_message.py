...
class InvalidAddressErrorMessageTest(X1coinTestFramework):
    ...
    def test_validateaddress(self):
        ...
        assert_raises_rpc_error(-1, "Return information about the given x1coin address.", node.validateaddress)
