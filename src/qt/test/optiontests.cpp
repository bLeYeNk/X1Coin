...
{
    // Test regression https://github.com/bitcoins/bitcoins/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/bitcoins-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/bitcoins-core/gui/pull/568.
    // With fListen=false in ~/.config/Bitcoins/Bitcoins-Qt.conf and all else left as default,
    // bitcoins-qt should set both -listen and -listenonion to false and start successfully.
