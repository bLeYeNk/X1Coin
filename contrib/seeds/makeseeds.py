...
def parse_args():
    argparser = argparse.ArgumentParser(description='Generate a list of x1coin node seed ip addresses.')
...
def main():
    ...
    # Filter out hosts with multiple x1coin ports, these are likely abusive
    ips = filtermultiport(ips)
    print(f'{ip_stats(ips):s} Filter out hosts with multiple x1coin ports', file=sys.stderr)
