...
class InvalidAddressErrorMessageTest(BitcoinsTestFramework):
    ...
    def test_validateaddress(self):
        ...
        assert_raises_rpc_error(-1, "Return information about the given bitcoins address.", node.validateaddress)
