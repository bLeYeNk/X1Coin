...
class NetTest(BitcoinsTestFramework):
    ...
    def test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(address=ipv6_addr, port=15258)
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 15258)
    ...
    def test_addpeeraddress(self):
        ...
        assert_equal(node.addpeeraddress(address="", port=15258), {"success": False})
