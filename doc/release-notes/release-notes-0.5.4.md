Bitcoins version 0.5.4 is now available for download at:
http://sourceforge.net/projects/bitcoins/files/Bitcoins/bitcoins-0.5.4/
...
http://gitorious.org/bitcoins/bitcoinsd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Bitcoins-Qt notifications under Growl 1.3.
Increase required age of Bitcoins-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoins properly when installing Bitcoins-Qt over it. (Windows)
