...
# Extract options
function __fish_bitcoins_tx_get_options
...
# Extract commands
function __fish_bitcoins_tx_get_commands
...
complete \
    --command bitcoins-tx \
    --condition "not __fish_bitcoins_seen_cmd (__fish_bitcoins_tx_get_commands --commandsonly)" \
    --arguments "(__fish_bitcoins_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command bitcoins-tx \
    --arguments "(__fish_bitcoins_tx_get_commands)" \
    --no-files
