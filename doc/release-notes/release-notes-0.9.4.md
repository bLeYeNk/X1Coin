Bitcoins Core version 0.9.4 is now available from:

  https://bitcoins.org/bin/0.9.4/
...
this update is incompatible with the Bitcoins system and could lead to consensus
forks.

Bitcoins Core released binaries from https://bitcoins.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~bitcoins/+archive/ubuntu/bitcoins
- A third-party or self-compiled Bitcoins Core

upgrade to Bitcoins Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
