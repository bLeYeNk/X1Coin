...
bech32_templates = [
  ...
  ('x1',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('x1',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('x1',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('x1',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('tx1',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tx1',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tx1',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('tx1',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('tx1',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('tx1',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('tx1',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('tx1',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('rx1',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('rx1',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('rx1',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('rx1', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('tx1',   17, 32, Encoding.BECH32M, False, False, False),
  ('rx1',  3,  1, Encoding.BECH32M, False, False, False),
  ('x1',   15, 41, Encoding.BECH32M, False, False, False),
  ('tx1',    0, 16, Encoding.BECH32,  False, False, False),
  ('rx1',  0, 32, Encoding.BECH32,  True,  False, False),
  ('x1',    0, 16, Encoding.BECH32,  True,  False, False),
  ('tx1',    0, 32, Encoding.BECH32,  False, True,  False),
  ('rx1',  0, 20, Encoding.BECH32,  False, False, True),
  ('x1',    0, 20, Encoding.BECH32M, False, False, False),
  ('tx1',    0, 32, Encoding.BECH32M, False, False, False),
  ('rx1',  0, 20, Encoding.BECH32M, False, False, False),
  ('x1',    1, 32, Encoding.BECH32,  False, False, False),
  ('tx1',    2, 16, Encoding.BECH32,  False, False, False),
  ('rx1', 16, 20, Encoding.BECH32,  False, False, False),
]
