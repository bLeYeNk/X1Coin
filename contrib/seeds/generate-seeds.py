...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef BITCOINS_CHAINPARAMSSEEDS_H\n')
    g.write('#define BITCOINS_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the bitcoins network\n')
    ...
    g.write('#endif // BITCOINS_CHAINPARAMSSEEDS_H\n')
