...
#ifndef BITCOINS_CRYPTO_CHACHA_POLY_AEAD_H
#define BITCOINS_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@bitcoins.
 *
 ...
 *
 * The chacha20-poly1305@bitcoins combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@bitcoins cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@bitcoins are relatively fast in
...
#endif // BITCOINS_CRYPTO_CHACHA_POLY_AEAD_H
