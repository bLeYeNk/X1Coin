...
complete --command bitcoins-qt --no-files

# Extract options
function __fish_bitcoinsqt_get_options
...
complete \
    --command bitcoins-qt \
    --arguments "(__fish_bitcoinsqt_get_options --nofiles)"
