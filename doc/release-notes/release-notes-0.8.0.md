Bitcoins-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/bitcoins/files/Bitcoins/bitcoins-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Bitcoins
...
New/changed settings (command-line or bitcoins.conf file)
--------------------------------------------------------
