...
#ifndef X1COIN_WALLET_WALLETUTIL_H
#define X1COIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! x1coin from opening the wallet, thinking it was newly created, and
...
#endif // X1COIN_WALLET_WALLETUTIL_H
