...
complete --command bitcoinsd --no-files

# Extract options
function __fish_bitcoinsd_get_options
...
complete \
    --command bitcoinsd \
    --arguments "(__fish_bitcoinsd_get_options --nofiles)"
