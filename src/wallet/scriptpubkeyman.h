...
#ifndef BITCOINS_WALLET_SCRIPTPUBKEYMAN_H
#define BITCOINS_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Bitcoins Core wallet was originally a collection of unrelated private
...
#endif // BITCOINS_WALLET_SCRIPTPUBKEYMAN_H
