...
This directory contains the files necessary to perform bootstrappable Bitcoins
Core builds.
...
To build Bitcoins Core reproducibly with all default options, invoke the
...
2. The `guix-codesign` command ***requires*** a `DETACHED_SIGS_REPO` flag.
    * _**DETACHED_SIGS_REPO**_
      ...
      Bitcoins Core version being built.
...
```
env DETACHED_SIGS_REPO=<path/to/bitcoins-detached-sigs> ./contrib/guix/guix-codesign
```
...
repository](https://github.com/bitcoins-core/guix.sigs).
