...
#ifndef X1COIN_UTIL_SYSCALL_SANDBOX_H
#define X1COIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during x1coind initialization if X1coin was compiled
...
#endif // X1COIN_UTIL_SYSCALL_SANDBOX_H
